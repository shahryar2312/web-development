...
Feel free to ask questions!`,
  ...
  p3: {
    ...
    hub:    { _id: 'h2', name: 'Minecraft', slug: 'minecraft' },
  ...
  p4: {
    ...
    hub:    { _id: 'h5', name: 'CSGO2', slug: 'csgo2' },
  ...
  p5: {
    ...
    hub:    { _id: 'h3', name: 'FIFA25', slug: 'fifa25' },
    createdAt: new Date(Date.now() - 24 * 3600 * 1000).toISOString(),
  },
  ep1: {
    _id: 'ep1',
    title: '[SPOILER] Ending lore breakdown — all 6 endings explained',
    content: 'Here is a detailed breakdown of all 6 endings in Elden Ring...',
    type: 'text',
    voteScore: 5210,
    commentCount: 302,
    tags: ['lore', 'spoiler', 'endings'],
    isPinned: false,
    isLocked: false,
    author: { username: 'tarnished_one' },
    hub:    { _id: 'h4', name: 'Elden Ring', slug: 'elden-ring' },
