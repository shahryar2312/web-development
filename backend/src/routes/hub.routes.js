...
router.post('/:hubId/moderators/:userId',   protect, addModerator);
router.delete('/:hubId/moderators/:userId', protect, removeModerator);
router.post('/:hubId/ban/:userId',          protect, hubBanUser);
router.delete('/:hubId/ban/:userId',        protect, hubUnbanUser);
